...
void Renderer::Init()
{
	...
	// デバイス、スワップチェーン(バックバッファ フロントバッファの切り替え)作成
	...
	// デプスステンシルバッファ作成(デプス 奥行とかがわかるようになるやつ? zバッファ)
	...
	// ミップマップ　(距離によって描画するテクスチャのサイズが変わる)　ただまだ汚いから異方性フィルタリング(Anisotropic Filtering)を入れる
