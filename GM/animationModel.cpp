...
void AnimationModel::LoadAnimaiton(const char* FileName, const char *Animation)
{
	m_Animation[Animation] = aiImportFile(FileName, aiProcess_ConvertToLeftHanded);
	assert(m_Animation[Animation]);
}
