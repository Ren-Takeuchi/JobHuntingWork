...
void ResultPolygon2D::Update()
{

}

void ResultPolygon2D::Draw()
{
	// 入力レイアウト設定
	...
	// マトリックス設定
	Renderer::SetWorldViewProjection2D(); // これは2D用のやつ3Dで入らない
